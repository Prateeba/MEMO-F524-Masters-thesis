...
More interestingly, the hardness result for configuration-to-configuration and configuration-to-edge still holds when the vertices of $G$
...
\section{Alternative Formulation of NCL : Sliding Tokens} \label{sec:sliding_tokens}
...
In this section we go over the $\PSPACE$-completeness result of the SLIDING TOKEN problem, proved by a reduction from NCL. As seen in section \ref{sec:ncl_results}, there are slightly different
...
\begin{theorem}Sliding Token problem is $\PSPACE$-complete. \end{theorem}
\begin{proof}
...
\begin{example}{Reduction Example.}

\textbf{Input RESTRICTED NCL instance} \hfill
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.4\textwidth}
    \begin{scaletikzpicturetowidth}{\textwidth}
      ...
      \end{tikzpicture}
    \end{scaletikzpicturetowidth}
    \caption{Initial configuration = $C_0$}
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \begin{scaletikzpicturetowidth}{\textwidth}
      ...
      \end{tikzpicture}
    \end{scaletikzpicturetowidth}
    \caption{Target configuration = $C_3$}
...
%%%%%%%%%%%%%%%%%%%%%%% Output instance %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Output Sliding-Token instance} \hfill
\begin{figure}[H]
  \centering
  \begin{scaletikzpicturetowidth}{\textwidth}
    \begin{tikzpicture}[scale=0.9]
      ...
      %%%%%%%%%%% EDGES %%%%%%%%%
      \node (a) at (2,-2) {\textbf{A}};            % Label reject
      ...
      \draw [-, red, thick, arrows={->[scale=3,red]}] (\xb+0.5,\yb-0.8) to [out=5,in=250] (\xc+0.5,\yc-0.8);             % AND 2  -- AND 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd-1.5,\yd-1.5) to [out=120,in=170] (\xa,\ya);                 % OR 1  -- AND 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd+1.5,\yd-1.5) to [out=330,in=200] (\xf-1.5,\yf-1.5);          % OR 1  -- OR 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf,\yf) to [out=100,in=340] (\xe+1.5,\ye-1.5);                 % OR 3  -- OR 2
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xe-1.5,\ye-1.5) to [out=200,in=40] (\xd,\yd+1);                  % OR 2  -- OR 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf+1.5,\yf-1.5) to [out=20,in=340] (\xc,\yc);                   % OR 3  -- AND 3
...
\begin{figure}[H]
  ...
  \begin{scaletikzpicturetowidth}{\textwidth}
    \begin{tikzpicture}[scale=0.9]
      ...
      \draw [-, red, thick, arrows={->[scale=3,red]}] (\xa-0.5,\ya-0.8)  to [out=280,in=170] (\xb-0.5,\yb-0.8);          % AND 1  -- AND 2
      \draw [-, red, thick, arrows={->[scale=3,red]}] (\xb+0.5,\yb-0.8) to [out=5,in=280] (\xc+0.5,\yc-0.8);             % AND 2  -- AND 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd-1.5,\yd-1.5) to [out=120,in=250] (\xa,\ya);                 % OR 1  -- AND 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd+1.5,\yd-1.5) to [out=320,in=190] (\xf-1.5,\yf-1.5);          % OR 1  -- OR 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf,\yf) to [out=100,in=340] (\xe+1.5,\ye-1.5);                 % OR 3  -- OR 2
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xe-1.5,\ye-1.5) to [out=200,in=70] (\xd,\yd+1);                  % OR 2  -- OR 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf+1.5,\yf-1.5) to [out=80,in=320] (\xc,\yc);                   % OR 3  -- AND 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xe,\ye+1) to [out=100,in=260] (\xb,\yb);                           % OR 2  -- AND 2
    \end{tikzpicture}
  \end{scaletikzpicturetowidth}
  \caption{Sliding Tokens vertex gadgets.}
...
\begin{figure}[H]
  ...
  \begin{scaletikzpicturetowidth}{\textwidth}
    \begin{tikzpicture}[scale=0.9]
      ...
      \draw [-, red, thick, arrows={->[scale=3,red]}]  (\xa+0.5,\ya-0.8) to [out=10,in=170]  (\xc-0.5,\yc-0.8);            % AND 1  -- AND 3
      \draw [-, red, thick, arrows={->[scale=3,red]}] (\xa-0.5,\ya-0.8)  to [out=280,in=170] (\xb-0.5,\yb-0.8);          % AND 1  -- AND 2
      \draw [-, red, thick, arrows={->[scale=3,red]}]  (\xc+0.5,\yc-0.8) to [out=280,in=5]  (\xb+0.5,\yb-0.8);             % AND 2  -- AND 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd-1.5,\yd-1.5) to [out=120,in=250] (\xa,\ya);                 % OR 1  -- AND 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xd+1.5,\yd-1.5) to [out=320,in=190] (\xf-1.5,\yf-1.5);          % OR 1  -- OR 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf,\yf) to [out=100,in=340] (\xe+1.5,\ye-1.5);                 % OR 3  -- OR 2
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xe-1.5,\ye-1.5) to [out=200,in=70] (\xd,\yd+1);                  % OR 2  -- OR 1
...
\begin{figure}[H]
  ...
  \begin{scaletikzpicturetowidth}{\textwidth}
    \begin{tikzpicture}[scale=0.9]
      ...
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xf,\yf) to [out=100,in=340] (\xe+1.5,\ye-1.5);                 % OR 3  -- OR 2
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xe-1.5,\ye-1.5) to [out=200,in=70] (\xd,\yd+1);                  % OR 2  -- OR 1
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xc,\yc) to [out=320,in=80]  (\xf+1.5,\yf-1.5);                   % OR 3  -- AND 3
      \draw [-, blue, thick, arrows={->[scale=3,blue]}] (\xb,\yb) to [out=260,in=100] (\xe,\ye+1);                           % OR 2  -- AND 2
    \end{tikzpicture}
  \end{scaletikzpicturetowidth}
  \caption{Sliding Tokens vertex gadgets.}
  \label{fig:output_instance_final}
...
The labelled sliding token problem is a variant of the Sliding token problem where each token has a unique label. The goal of this section is
to prove that the sliding token problem remains $\PSPACE$-hard even with labeled tokens. In order to prove that the labeled Sliding token
problem is $\PSPACE$-hard, we'll first prove that a slightly different version of the SLIDING TOKEN problem is also $\PSPACE$-hard. It is this
latter version that will be used to prove the $\PSPACE$-hardness of the labeled sliding token problem.

\subsection{Standard sliding token problem}
...
The goal now is to prove that if the Standard Sliding token problem is colourabable $i.e.,$ labeled with $k$-colours, then
...
Let $W$ be the sets of $G$ and $f: T \rightarrow W$ be a function where $T$ is the given set of token labels. $f$ is bijective because
