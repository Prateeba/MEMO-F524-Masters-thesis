...
\begin{example}{Find a name. \\}
\textbf{Input restricted NCL C2E instance} \hfill
...
\subsection{Labelled tokens} \label{subsection:coloring_problems} \todo{To redo this part}
...
The goal now is to prove that if the Standard Sliding token problem is $k$ colourabable $i.e.,$ labeled with $k$-colours, then
