...
%heuristic algorithms for satisﬁability and enhance their effectiveness. In this context, our
%ﬁndings are prima facie negative: we show that when satisﬁability is intractable, then con-
%nectivity is also intractable. But our results do contain a glimmer of hope: there are broad
%classes of intractable satisﬁability problems, those built from tight relations, with polynomial
%st-connectivity and small diameter. It would be interesting to investigate if these properties
...
\section{A computational Trichotomy}\label{sec:a-computational-trichotomy}
