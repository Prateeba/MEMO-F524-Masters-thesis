...
\begin{example} {$\mathcal{S = W} = \{a_1 = w_1 = 1 , a_2 = w_2 = 3 , a_3 = w_3 = 6\}$, $k = 1$ and $c = 7$}
      ...
      \begin{scaletikzpicturetowidth}{\textwidth}
        ...
        \begin{tikzpicture}[scale=0.8, x={({1}, {0})}]
          \begin{axis}[
            ...
            % upper
            %\addplot3[fill=red,fill opacity=0.5] coordinates {(0,1,4/6) (1,1,1/2) (1,0,1)  (0,1/3,1) (0,1,4/6)};
            %\addplot3 [only marks,mark=*] coordinates { (0,1,4/6) (1,1,1/2) (0,1/3,1)};
            %lower
            %\addplot3[fill=green,fill opacity=0.5] coordinates {(1,0,0) (0,1/3,0) (0,0,1/6) (1,0,0)} ;
            %\addplot3 [only marks,mark=*] coordinates { (1,0,0) (0,1/3,0) (0,0,1/6)};
            % solution paths
            \addplot3[mark=none,ultra thick] coordinates {(0,1,0) (1,1,0) (1,0,0) (1,0,1) (0,0,1)};
          \end{axis}
