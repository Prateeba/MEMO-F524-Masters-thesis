\chapter{SUBSET SUM RECONFIGURATION}\label{chap:subset-sum-reconf}
...
\section{LABELLED SLIDING TOKENS problem.}\label{sec:sliding_problem}
...
\begin{lemma} \label{lemma:ECR} The Exact Cover Reconfiguration problem is $\PSPACE$-hard for instances that are $23$-colourable hypergraphs. \end{lemma}
\begin{proof}
...
\begin{example}{Input instance of the LABELLED SLIDING TOKENS PROBLEM}
  \begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.4\textwidth}
      \begin{scaletikzpicturetowidth}{\textwidth}
        \begin{tikzpicture}[scale=1]
          ...
          \node (a) at (\xa+0.6,\ya+3) {\textcolor{violet}{\large $t_{1}$}};
          \node (b) at (\xa+1.3,\ya+0.6) {\textcolor{violet}{\large $t_{2}$}};
          % labels
    ...
    \begin{subfigure}[b]{0.4\textwidth}
      \begin{scaletikzpicturetowidth}{\textwidth}
        \begin{tikzpicture}[scale=1]
          ...
          \node (a) at (\xa+1,\ya+2.5) {\textcolor{violet}{\large $t_{1}$}};
          \node (b) at (\xa-1,\ya+0.5) {\textcolor{violet}{\large $t_{2}$}};
          % labels
          \node (1) at (\xa,\ya+3.5) {$v_1$};     % v1
          \node (2) at (\xa+1.5,\ya+2) {$v_2$};   % v2
          \node (3) at (\xa+1.5,\ya+1) {$v_3$};   % v3
    ...
    \end{subfigure}
    \caption{A LABELLED SLIDING TOKENS instance with initial and target configurations $S_{1}$ and $S_{2}$ respectively where $T = \{t_1, t_2\}$,
    $p_{1}(t_1) = v_1, p_{1}(t_2) = v_3$ and $p_{2}(t_1) = v_2, p_2(t_2) = v_4$ .}
...
\begin{example} Continuing with the running example, the output instance of the ECR problem is the following :
  \begin{enumerate}
    \item $\mathcal{U} = \{v_1, v_2, v_3, v_4, v_5, v_6\} \cup \{t_1, t_2\}$
    \item And $ \mathcal{S} = \{ \{v_2, v_3, v_5, v_6\}, \{v_1, v_3, v_5, v_6\}, \{t_1, v_1\}, \{t_1, v_2\}, \{t_1, v_1, v_2, v_3, v_5, v_6\}, \\ \{v_1, t_2\}, \{v_2, t_2\}, \{v_1, v_2, v_3, v_5, v_6, t_2\} \qquad \textcolor{gray}{(1,2)} \\
  \{v_2, v_4, v_5, v_6\}, \{v_2, v_4, v_5, v_6\}, \{t_1, v_1\}, \{t_1, v_3\}, \{t_1, v_2, v_4, v_5, v_6\}, \\ \{v_1, t_2\}, \{v_3, t_2\}, \{v_2, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(1,3)} \\
  \{v_2, v_3, v_4, v_5, v_6\}, \{v_1, v_2, v_3, v_4, v_6\}, \{t_1, v_1\}, \{t_1, v_5\}, \{t_1, v_1, v_2, v_3, v_4, v_5, v_6\}, \\ \{v_1, t_2\}, \{v_5, t_2\}, \{v_1, v_2, v_3, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(1,5)} \\
  \{v_2, v_3, v_5, v_6\}, \{v_2, v_3, v_5, v_6\}, \{t_1, v_1\}, \{t_1, v_4\}, \{t_1, v_2, v_3, v_5, v_6\}, \\ \{v_1, t_2\}, \{v_4, t_2\}, \{v_2, v_3, v_5, v_6, t_2\} \qquad \textcolor{gray}{(1,4)}\\
  \{v_2, v_4, v_5, v_6\}, \{v_1, v_2, v_4, v_5\}, \{t_1, v_1\}, \{t_1, v_6\}, \{t_1, v_1, v_2, v_4, v_5, v_6\}, \\ \{v_1, t_2\}, \{t_2, v_6\}, \{v_1, v_2, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(1,6)}\\
  \{v_1, v_3, v_4, v_5, v_6\}, \{v_1, v_2, v_4, v_5, v_6\}, \{t_1, v_2\}, \{t_1, v_3\}, \{t_1, v_1, v_2, v_3, v_4, v_5, v_6\}, \\ \{v_2, t_2\}, \{v_3, t_2\}, \{v_1, v_2, v_3, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(2,3)}\\
  \{v_1, v_3, v_4, v_6\}, \{v_1, v_3, v_4, v_6\}, \{t_1, v_2\}, \{t_1, v_5\}, \{t_1, v_1, v_3, v_4, v_6\}, \\ \{v_2, t_2\}, \{v_5, t_2\}, \{v_1, v_3, v_4, v_6, t_2\} \qquad \textcolor{gray}{(2,5)}\\
  \{v_1, v_3, v_5, v_6\}, \{v_1, v_3, v_5, v_6\}, \{t_1, v_2\}, \{t_1, v_4\}, \{t_1, v_1, v_3, v_5, v_6\}, \\ \{v_2, t_2\}, \{v_4, t_2\},  \{v_1, v_3, v_5, v_6, t_2\} \qquad \textcolor{gray}{(2,4)} \\
  \{v_1, v_3, v_4, v_6\}, \{v_1, v_2, v_3, v_4\}, \{t_1, v_2\}, \{t_1, v_6\}, \{t_1, v_1, v_2, v_3, v_4, v_6\}, \\ \{v_2, t_2\}, \{t_2, v_6\}, \{v_1, v_2, v_3, v_4, v_6, t_2\} \qquad \textcolor{gray}{(2,6)}\\
  \{v_1, v_2, v_4, v_5\}, \{v_1, v_2, v_3, v_4\}, \{t_1, v_3\}, \{t_1, v_5\}, \{t_1, v_1, v_2, v_3, v_4, v_5\}, \\ \{v_3, t_2\}, \{v_5, t_2\}, \{v_1, v_2, v_3, v_4, v_5, t_2\} \qquad \textcolor{gray}{(3,5)}\\
  \{v_2, v_4, v_5, v_6\}, \{v_2, v_3, v_5, v_6\}, \{t_1, v_3\}, \{t_1, v_4\}, \{t_1, v_2, v_3, v_4, v_5, 6\}, \\ \{v_3, t_2\}, \{v_4, t_2\}, \{v_2, v_3, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(3,4)}\\
  \{v_1, v_2, v_4, v_5\}, \{v_1, v_2, v_4, v_5\}, \{t_1, v_3\}, \{t_1, v_6\}, \{t_1, v_1, v_2, v_4, v_5\}, \\ \{v_3, t_2\}, \{t_2, v_6\}, \{v_1, v_2, v_4, v_5, t_2\} \qquad \textcolor{gray}{(3,6)}\\
  \{v_1, v_3, v_4, v_6\}, \{v_1, v_3, v_5, v_6\}, \{t_1, v_5\}, \{t_1, v_4\}, \{t_1, v_1, v_3, v_4, v_5, v_6\}, \\ \{v_5, t_2\}, \{v_4, t_2\}, \{v_1, v_3, v_4, v_5, v_6, t_2\} \qquad \textcolor{gray}{(5,4)}\\
  \{v_1, v_2, v_3, v_4\}, \{v_1, v_2, v_3, v_4\}, \{t_1, v_5\}, \{t_1, v_6\}, \{t_1, v_1, v_2, v_3, v_4\}, \\ \{v_5, t_2\}, \{t_2, v_6\}, \{v_1, v_2, v_3, v_4, t_2\} \qquad \textcolor{gray}{(5,6)}\\
  \{v_1, v_2, v_3, v_5, v_6\}, \{v_1, v_2, v_3, v_4, 5\}, \{t_1, v_4\}, \{t_1, v_6\}, \{t_1, v_1, v_2, v_3, v_4, v_5, v_6\}, \\ \{v_4, t_2\}, \{t_2,v_6\}, \{v_1, v_2, v_3, v_4, v_5,v_6, t_2\} \qquad \textcolor{gray}{(4,6)} \} $

  \end{enumerate}
\end{example}

\subsubsection{Preliminaries} \label{subsubsection:prelim}
Before diving in the proof, a few notions used in the reduction are presented hereunder :
\paragraph{Slide Set.}
For each pair of adjacent vertices $v_i, v_j \in V$ of the input instance of the SLIDING TOKENS problem, the set consisting of these two vertices
and their neighbours is called a $slide set$, denoted $S_{i,j}$.
\begin{figure}[H]
  \begin{center}
    \begin{scaletikzpicturetowidth}{\textwidth}
      \begin{tikzpicture}[scale=1]
...
compute $\Delta(G^{3})$. Since $G$ is $3-$regular, $G^3$ has degree at most $21$ proven by the following figure.
...
\begin{proof}The reduction is from the ECR problem for instances that are $23-$colourable induced hypergraphs,
...
\begin{example} The following example shows the geometric interpretation of an instance denoted $I$ of the Knapsack reconfiguration problem where
  $\mathcal{W} = \{1, 3, 6\}$, $l = 1$ and $u = 7$. The $n$-hypercube induced by all possible configurations of $I$ is shown in blue in figure
  \ref{fig:geo_1}, the two linear upper and lower bound constraints are represented by the yellow and orange hyperplanes respectively. It is very
interesting to notice that the feasible configurations to the given instance are the points lying between the yellow and orange hyperplanes and the
red path represent the reconfiguration sequence between the feasible solutions. Notice that this path is also included in the polytope $P$ delimited by the
hyperplanes.
  ...
  \begin{figure}[H]
        ...
        \begin{tikzpicture}[scale=1.2, x={({1}, {0})}]
          \begin{axis}[
            ...
            % solution paths
            \addplot3[draw=red, mark=none,ultra thick] coordinates {(0,1,0) (1,1,0) (1,0,0) (1,0,1) (0,0,1)};
          \end{axis}
        \end{tikzpicture}
...
\subsection{$3$-move Subset sum reconfiguration $\rightarrow$ Constrained Hypercube Path problem}
...
\begin{example} {The following example shows the geometric interpretation of an instance denoted $I$ of the $3$-move subset sum reconfiguration
problem where $\mathcal{S} = \{2, 3, 5\}$ and $x = 5$. The $n$-hypercube induced by all possible configurations of $I$ denoted $Q$ is shown in dotted
blue in figure \ref{fig:geo_1}. The hyperplane representing the target sum constraint is represented in yellow. The solutions to this given instance
is the points of $Q$ that lies in the hyperplane. The red path represents the reconfiguration sequence between the feasible solutions.
}
  \begin{figure}[H]
        \centering
        \begin{tikzpicture}[scale=1.2, x={({1}, {0})}]
